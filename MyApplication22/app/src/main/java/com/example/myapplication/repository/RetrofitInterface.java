...
public interface RetrofitInterface {
    ...
    @FormUrlEncoded
    @POST("php/getLogEventbyiduser.php")
    Call<List<LogEventModel>> readAllLogEventByIdCustomer(
            @Field("iduser") int iduser);
    @FormUrlEncoded
    @POST("php/getrequestbyidorder.php")
    Call<List<Request>> getRequestsByidorder(
            @Field("idorder") String idorder);
    @FormUrlEncoded
    @POST("php/updaterequest.php")
    Call<ResponseModel> updateRequest(
            @Field("idcus") int idcus,
            @Field("idrequest") String idorder,
            @Field("status") String status,
            @Field("note") String note,
